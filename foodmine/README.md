...
21. Deploy On Heroku
    ...
    5.  Run commands
		a. Build backend (prebuild)
			i. Terminal > root folder > npm run prebuild
		b. Build frontend (build)
			i. Terminal > root folder > npm run build
		c. Copy .env file into built directory
		d. Start Server
			i. Terminal > root folder > npm start
			ii: browse @ http://localhost:5200/
